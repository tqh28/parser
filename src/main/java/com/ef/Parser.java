...
//		LogFile.writeLogFileToDatabase(query, "C:\\Users\\huytranq2\\Desktop\\Java_MySQL_Test\\access.log");
		
		OverThreshold overThreshold = new OverThreshold(query);
		overThreshold.getOverThreshold(arguments.get("startDate"), arguments.get("duration"), arguments.get("threshold"));
