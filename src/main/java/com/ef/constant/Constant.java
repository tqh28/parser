...
public class Constant {
	...
	public static final String CREATE_ACCESS_LOG_TABLE_QUERY =
			"CREATE TABLE access_log(id int PRIMARY KEY AUTO_INCREMENT, access_time datetime(3), ip varchar(16))";
	
	public static final String INSERT_INTO_ACCESS_LOG_PREFIX_QUERY =
			"INSERT INTO access_log (access_time, ip) VALUES ";
	
	public static final String INSERT_INTO_ACCESS_LOG_DATA_FORM = "('%s', '%s'), ";
	
	public static final String GET_IP_OVER_THRESHOLD_QUERY =
			"SELECT COUNT(*) sum, ip FROM access_log WHERE access_time < ADDTIME('%s', '%s') and access_time > '%s' GROUP BY ip HAVING COUNT(*) > %s";
	public static final String ADD_ONE_HOUR = "1:0:0.000";
	public static final String ADD_ONE_DAY = "0-0-1 0:0:0.000";
